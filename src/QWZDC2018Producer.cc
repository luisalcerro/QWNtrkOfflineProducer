...
using namespace std;
class QWZDC2018Producer : public edm::one::EDProducer<edm::one::WatchRuns> {
public:
  explicit QWZDC2018Producer(const edm::ParameterSet&);
  ~QWZDC2018Producer() override;
...
QWZDC2018Producer::~QWZDC2018Producer() { return; }
...
void QWZDC2018Producer::beginRun(const edm::Run& r, const edm::EventSetup& iSetup) { return; }
void QWZDC2018Producer::endRun(const edm::Run& r, const edm::EventSetup& iSetup) { return; }
